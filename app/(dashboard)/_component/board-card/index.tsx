...
const BoardCard = ({id,title,authorId,authorName,createdAt,orgId,imageUrl,isFavourite}:BoardCardProps) => {
  ...
  return (
   <Link href={`/board/${id}`}>
    ...
    <div className='relative flex-1 bg-amber-500'>
        <Image src={imageUrl}
        alt={title} 
        fill
